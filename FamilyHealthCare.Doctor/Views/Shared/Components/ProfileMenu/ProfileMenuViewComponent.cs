...
namespace FamilyHealthCare.Doctor.Views.Shared.Components.ProfileMenu
{
    public class ProfileMenuViewComponent : ViewComponent
    {
        ...
        public ProfileMenuViewComponent(IHttpClientFactory clientFactory, IHttpContextAccessor httpContext)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            return View("ProfileMenu", profile);
        }
    }
}
